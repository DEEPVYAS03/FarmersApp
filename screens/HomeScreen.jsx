...
import {View, Text, Pressable, Touchable, ScrollView} from 'react-native';
...
const HomeScreen = () => {
  ...
  return (
    <View style={tw`mt-10 ml-3`}>
      <Text style={tw`font-bold text-xl text-black`}>HomeScreen</Text>
      <View style={tw`bg-gray-200 w-93 mt-3 rounded-lg  h-40`}>
        <View style={tw`flex flex-row`}>
          <View style={tw`m-2 ml-5`}>
            <Text style={tw`text-base text-black`}>{data.name}</Text>
        ...
        <View style={tw`m-2 flex-row items-center justify-around`}>
          <Text style={tw`text-3xl mt-3 text-black`}>{temp}°C</Text>
          <View>
            <View style={tw`flex-row items-center`}>
              <Text style={tw`text-xs text-black`}>Feels like</Text>
              <Text style={tw`font-black ml-5 text-black`}>{feelslike}°C</Text>
            </View>
            <View style={tw`flex-row items-center`}>
              <Text style={tw`text-xs text-black`}>Humidity</Text>
              <Text style={tw`font-black ml-5 text-black`}>{humidity}%</Text>
            </View>
            <View style={tw`flex-row items-center`}>
              <Text style={tw`text-xs text-black`}>Wind speed</Text>
              <Text style={tw`font-black ml-2 text-black`}>
                {windspeed} KPH
              </Text>
            </View>
          </View>
      ...
      <View style={tw`mt-4`}>
        <Text style={tw`text-black`}>Recent Orders:</Text>
        <View>
          <OrderCard />
        </View>
        <View style={tw`mt-3`}>
          <Text style={tw`text-black`}>Market Information:</Text>
          <Mandi />
        </View>
      </View>
    </View>
